                            ...
                            <form class="form-horizontal" method="post" action="{{ url('admin/location/edit/'.$getRecord->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ $getRecord->street_address }}" name="street_address" class="form-control" required placeholder="Enter Street Address">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ $getRecord->postal_code }}" name="postal_code" class="form-control" required placeholder="Enter Postal Code">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ $getRecord->city }}" name="city" class="form-control" required placeholder="Enter City">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ $getRecord->state_provice }}" name="state_provice" class="form-control" required placeholder="Enter State Provice">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="countries_id" required>
                                                ...
                                                @foreach($getCountries as $countries)
                                                    <option {{ ($countries->id == $getRecord->countries_id) ? 'selected' : '' }} value="{{ $countries->id }}">{{ $countries->country_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
