                            ...
                            <form class="form-horizontal" method="post" action="{{ url('admin/job_grades/add') }}" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ old('grade_level') }}" name="grade_level" class="form-control" required placeholder="Enter Grade Label">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" value="{{ old('lowest_sal') }}" name="lowest_sal" class="form-control" required placeholder="Enter Lowest Sal">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" value="{{ old('highest_sal') }}" name="highest_sal" class="form-control" required placeholder="Enter Highest Sal">
                                        </div>
                                    </div>
