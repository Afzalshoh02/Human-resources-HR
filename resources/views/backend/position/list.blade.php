                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-1">
                                            ...
                                            <input type="text" name="position_name" class="form-control" value="{{ Request()->position_name }}" placeholder="Enter Position Name">
                                        </div>

                                        <div class="form-group col-md-1">
                                            <label>Daily Rate</label>
                                            <input type="text" name="daily_rate" class="form-control" value="{{ Request()->daily_rate }}" placeholder="Enter Daily Rate">
                                        </div>

                                        <div class="form-group col-md-1">
                                            <label>Monthly Rate</label>
                                            <input type="text" name="monthly_rate" class="form-control" value="{{ Request()->monthly_rate }}" placeholder="Enter Monthly Rate">
                                        </div>

                                        <div class="form-group col-md-3">
                                            <label>Working Days Per Month</label>
                                            <input type="text" name="working_days_per_month" class="form-control" value="{{ Request()->working_days_per_month }}" placeholder="Enter Working Days Per Month">
                                        </div>

                                        <div class="form-group col-md-1">
                                            <label>Created At</label>
                                            <input type="text" name="created_at" class="form-control" value="{{ Request()->id }}" placeholder="Enter Created At">
                                        </div>

                                        <div class="form-group col-md-1">
                                            <label>Update At</label>
                                            <input type="text" name="updated_at" class="form-control" value="{{ Request()->id }}" placeholder="Enter Update At">
                                        </div>
