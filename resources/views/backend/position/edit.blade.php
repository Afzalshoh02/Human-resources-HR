                            ...
                            <form class="form-horizontal" method="post" action="{{ url('admin/position/edit/'.$getRecord->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ $getRecord->position_name }}" name="position_name" class="form-control" required placeholder="Enter Position Name">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" value="{{ $getRecord->daily_rate }}" name="daily_rate" class="form-control" required placeholder="Enter Daily Rate">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" value="{{ $getRecord->monthly_rate }}" name="monthly_rate" class="form-control" required placeholder="Enter Monthly Rate">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" value="{{ $getRecord->working_days_per_month }}" name="working_days_per_month" class="form-control" required placeholder="Enter Working Days Per Month">
                                        </div>
                                    </div>
